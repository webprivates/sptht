<div class="row">
	<div class="col-md-12">
		...
		<a href="<?php echo site_url()?>/kelompok_gejala/create" class="btn btn-success btn-sm" >Tambah data</a>
		<table class="table table-striped table-responsive">
			...
			<tr>
				...
				<td>
					<a href="<?php echo site_url('/kelompok_gejala/edit/'.$data['id'])?>" class="btn btn-success btn-sm" >Edit</a>
