         <!-- /menu footer buttons -->
        <div class="sidebar-footer hidden-small" style="background:#1ABB9C">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" style="background:#1ABB9C" href="<?php echo base_url () ?>/admin/logout">
